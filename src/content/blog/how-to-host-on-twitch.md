---
name: How to Host on Twitch
slug: how-to-host-on-twitch
coverImage: "https://uploads-ssl.webflow.com/64a306a998b13b212f4bbb35/65a2a909dfb066fa31b6aabd_twitch-host.png"
ogImage: "https://uploads-ssl.webflow.com/64a306a998b13b212f4bbb35/65a2a90ccf51fb0486e72c96_twitch-hosting-open.png"
author: kody-wirth
category: twitch
featured: false
...
- Go to your **channel page** (twitch.com/username)
- Type the following in your chat: **/host [channel]** to host another stream on your channel
...
- Go to the channel you want to host
- Click the share icon at the top of the stream 
- Select Host Channel
...
- Switch to **ON**
- If you have a Twitch team, switch the **Team Hosting** setting to **ON**. This will prioritize hosting members of your Twitch Team.
- If you want to host a specific channel, click the **+** sign in the top right of the **Host List** section and type the name of the channel to add. You can choose to host channels randomly or host channels in the order they appear on your list. 
- Decide if you want to auto host similar channels with Twitch’s algorithm to host channels that have overlapping viewership. 
- Click **Save Changes**.
